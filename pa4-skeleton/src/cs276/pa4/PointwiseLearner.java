...
//
    Quad<Instances, List<Pair<Query, Document>>, ArrayList<Attribute>, Map<Integer, List<Integer>>>
        trainData = Util.loadSignalFileLinearRegression(train_data_file,idfs,train_rel_file);
  ...
  public TestFeatures extractTestFeatures(String test_data_file,
     ...
     */
    Quad<Instances, List<Pair<Query, Document>>, ArrayList<Attribute>, Map<Integer, List<Integer>>>
        testData = Util.loadSignalFileLinearRegression(test_data_file,idfs,null);
