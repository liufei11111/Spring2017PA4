 ...
 */
public class PairwiseLearnerPart3 extends Learner{
  private LibSVM model;
  public PairwiseLearnerPart3(boolean isLinearKernel){
    try{
      model = new LibSVM();
    } catch (Exception e){
      e.printStackTrace();
  ...
  public PairwiseLearnerPart3(double C, double gamma, boolean isLinearKernel){
    try{
      model = new LibSVM();
    } catch (Exception e){
      e.printStackTrace();
