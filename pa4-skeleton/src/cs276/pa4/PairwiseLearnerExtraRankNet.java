 ...
 */
public class PairwiseLearnerExtraRankNet extends Learner{
  private RankBoost model;
  public PairwiseLearnerExtraRankNet(){
    model = new RankBoost();
  ...
  public Map<Query, List<Document>> testing(TestFeatures tf, Classifier model) {
    ...
    RankNet rb = RankLibWrapper.loadModelRankNet();
  ...
  private void orderDocs(List<Document> docsPerQuery,
      Map<Pair<Document, Document>, Integer> findPairIndex, Ranker model, TestFeatures tf,Map<Integer, Integer> rowToQueryID) {
